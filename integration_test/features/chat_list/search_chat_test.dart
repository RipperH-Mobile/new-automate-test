  ...
  patrolTest('Search chat scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await SearchChatStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_list_search_chat_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
