  ...
  patrolTest('Pin chat scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await PinChatStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_list_pin_chat_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
