  ...
  patrolTest('Edit chat list scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await EditChatListStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_list_edit_chat_list_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
