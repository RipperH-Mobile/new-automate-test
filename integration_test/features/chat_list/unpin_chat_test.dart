  ...
  patrolTest('Unpin chat scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await UnpinChatStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_list_unpin_chat_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
