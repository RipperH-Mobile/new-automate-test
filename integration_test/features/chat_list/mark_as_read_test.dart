  ...
  patrolTest('Mark as read chat scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await MarkAsReadStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_list_mark_as_read_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
