  ...
  patrolTest('Direct pin chat scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await DirectPinChatStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_room_direct_chat_pin_chat_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
