  ...
  patrolTest('Group system message scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await GroupSystemMessageStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_room_group_system_message_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
