  ...
  patrolTest('Group leave chat scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await GroupLeaveChatStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_room_group_leave_chat_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
