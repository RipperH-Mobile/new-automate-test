  ...
  patrolTest('Direct new chat scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await DirectNewChatStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_room_direct_chat_new_chat_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
