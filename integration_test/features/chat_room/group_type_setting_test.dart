  ...
  patrolTest('Group type setting scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await GroupTypeSettingStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_room_group_type_setting_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
