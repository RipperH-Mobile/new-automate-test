  ...
  patrolTest('Unpin message scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await UnpinMessageStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_unpin_message_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
