  ...
  patrolTest('Reply message successful', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await ReplyMessageStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_reply_message_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
