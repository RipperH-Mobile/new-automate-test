  ...
  patrolTest('Search message scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await SearchMessageStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_chat_search_message_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
