  ...
  patrolTest('Delete account scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await DeleteAccountStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_account_delete_account_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
