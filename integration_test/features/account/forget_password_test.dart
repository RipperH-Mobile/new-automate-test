  ...
  patrolTest('Forget password scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await ForgetPasswordStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_account_forget_password_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
