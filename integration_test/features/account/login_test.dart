  ...
  patrolTest('Login scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await LoginStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_account_login_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
