  ...
  patrolTest('Account setting scenario', ($) async {
    try {
      ...
      for (final dataRow in testData) {
        resultsData = await AccountSettingStep().proceedTest($, dataRow, resultsData);
...
void runTests() {
  ...
  tearDown(() async {
    ...
    const String outputFilename = 'feature_account_account_setting_test_${deviceTarget}_${envTarget}_batch.csv';
    Directory directory;
    if (Platform.isIOS) {
