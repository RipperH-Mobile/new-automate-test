...
class PinChatStep {
  ...
  Future<List<Map<String, dynamic>>> proceedTest($, dataRow, resultsData) async {
    ...
    final config = PinChatTestConfig.fromRow(dataRow);
  ...
  Future<void> _performRegistration($, PinChatTestConfig config) async {
  ...
  Future<void> _performAddFriendAndChat($, PinChatTestConfig config) async {
  ...
  Future<void> _performAction($, PinChatTestConfig config) async {
  ...
  Future<void> _performExpectedSuccess($, PinChatTestConfig config) async {
  ...
  Future<void> _performExpectedFail($, PinChatTestConfig config) async {}

  Future<void> _performCleanup($, PinChatTestConfig config) async {
...
class PinChatTestConfig {
  ...
  PinChatTestConfig.fromRow(Map<String, dynamic> row)
