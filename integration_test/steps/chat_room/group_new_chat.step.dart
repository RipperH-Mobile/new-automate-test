...
class GroupNewChatStep {
  ...
  Future<List<Map<String, dynamic>>> proceedTest($, dataRow, resultsData) async {
    ...
    final config = GroupNewChatTestConfig.fromRow(dataRow);
  ...
  Future<void> _performRegistration($, GroupNewChatTestConfig config) async {
  ...
  Future<void> _performAddFriends($, GroupNewChatTestConfig config) async {
  ...
  Future<void> _performCreateGroup($, GroupNewChatTestConfig config) async {
    await _createNewGroupWorkflow.proceedCreateGroup($, config.addMemberDetail, config.groupName);
  }

  Future<void> _performJoinGroup($, LoginPage _loginPage, GroupNewChatTestConfig config) async {
    await _joinNewGroupWorkflow.proceedJoinNewGroup($, _loginPage, config);
  }

  Future<void> _performAction($, GroupNewChatTestConfig config) async {
    await _loginUser($, config.loginByOwnerPhone, config.loginByOwnerPassword, true);
  ...
  Future<void> _performExpectedSuccess($, GroupNewChatTestConfig config) async {
  ...
  Future<void> _performExpectedFail($, GroupNewChatTestConfig config) async {}

  Future<void> _performCleanup($, GroupNewChatTestConfig config) async {
...
class GroupNewChatTestConfig {
  ...
  GroupNewChatTestConfig.fromRow(Map<String, dynamic> row)
