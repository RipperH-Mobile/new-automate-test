...
class DirectPinChatStep {
  ...
  Future<List<Map<String, dynamic>>> proceedTest($, dataRow, resultsData) async {
    ...
    final config = DirectPinChatTestConfig.fromRow(dataRow);
  ...
  Future<void> _performRegistration($, DirectPinChatTestConfig config) async {
  ...
  Future<void> _performAddFriendAndChat($, DirectPinChatTestConfig config) async {
  ...
  Future<void> _performAction($, DirectPinChatTestConfig config) async {
  ...
  Future<void> _performExpectedSuccess($, DirectPinChatTestConfig config) async {
  ...
  Future<void> _performExpectedFail($, DirectPinChatTestConfig config) async {}

  Future<void> _performCleanup($, DirectPinChatTestConfig config) async {
...
class DirectPinChatTestConfig {
  ...
  DirectPinChatTestConfig.fromRow(Map<String, dynamic> row)
      : isDeleteAfterRun = CommonUtil.convertStringToBoolean(row['is_delete_after_run']),
        ...
        isPinChat = CommonUtil.convertStringToBoolean(row['is_pin_chat']),
