...
class DirectDeleteHistoryChatStep {
  ...
  Future<List<Map<String, dynamic>>> proceedTest($, dataRow, resultsData) async {
    ...
    final config = DirectDeleteHistoryChatTestConfig.fromRow(dataRow);
  ...
  Future<void> _performRegistration($, DirectDeleteHistoryChatTestConfig config) async {
  ...
  Future<void> _performAddFriendAndChat($, DirectDeleteHistoryChatTestConfig config) async {
  ...
  Future<void> _performAction($, DirectDeleteHistoryChatTestConfig config) async {
  ...
  Future<void> _performExpectedSuccess($, DirectDeleteHistoryChatTestConfig config) async {
  ...
  Future<void> _performExpectedFail($, DirectDeleteHistoryChatTestConfig config) async {}

  Future<void> _performCleanup($, DirectDeleteHistoryChatTestConfig config) async {
...
class DirectDeleteHistoryChatTestConfig {
  ...
  DirectDeleteHistoryChatTestConfig.fromRow(Map<String, dynamic> row)
