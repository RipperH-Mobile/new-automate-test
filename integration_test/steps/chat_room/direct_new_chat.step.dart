...
class DirectNewChatStep {
  ...
  Future<List<Map<String, dynamic>>> proceedTest($, dataRow, resultsData) async {
    ...
    final config = DirectNewChatTestConfig.fromRow(dataRow);
  ...
  Future<void> _performRegistration($, DirectNewChatTestConfig config) async {
  ...
  Future<void> _performAddFriend($, DirectNewChatTestConfig config) async {
  ...
  Future<void> _performAction($, DirectNewChatTestConfig config) async {
  ...
  Future<void> _performExpectedSuccess($, DirectNewChatTestConfig config) async {
    await $.pump();
  ...
  Future<void> _performExpectedFail($, DirectNewChatTestConfig config) async {}

  Future<void> _performCleanup($, DirectNewChatTestConfig config) async {
...
class DirectNewChatTestConfig {
  ...
  DirectNewChatTestConfig.fromRow(Map<String, dynamic> row)
