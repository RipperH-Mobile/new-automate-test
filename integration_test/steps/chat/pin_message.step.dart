...
class PinMessageStep {
  ...
  Future<List<Map<String, dynamic>>> proceedTest($, dataRow, resultsData) async {
    ...
    final config = PinMessageTestConfig.fromRow(dataRow);
  ...
  Future<void> _performRegistration($, PinMessageTestConfig config) async {
  ...
  Future<void> _performAddFriends($, PinMessageTestConfig config) async {
  ...
  Future<void> _performCreateGroup($, PinMessageTestConfig config) async {
    await _createNewGroupWorkflow.proceedCreateGroup($, config.addMemberDetail, config.groupName);
  }

  Future<void> _performJoinGroup($, LoginPage _loginPage, PinMessageTestConfig config) async {
  ...
  Future<void> _performPinMessage($, PinMessageTestConfig config) async {
  ...
  Future<void> _performCleanup($, PinMessageTestConfig config) async {
...
class PinMessageTestConfig {
  ...
  PinMessageTestConfig.fromRow(Map<String, dynamic> row)
