...
const Duration _previewLongPressTimeout = Duration(milliseconds: 400);
...
class CupertinoContextMenu extends StatefulWidget {
  ...
  /// A callback that is called when the [CupertinoContextMenu] is tapped.
  ///
  /// This callback is called when the [CupertinoContextMenu] is tapped,
  /// but not opened the context menu.
  final VoidCallback? onJustTap;
  final Function(TapDownDetails details)? onTapDownCallBack;
...
class _CupertinoContextMenuState extends State<CupertinoContextMenu> with TickerProviderStateMixin {
  ...
  void _onTapDown(TapDownDetails details) {
    widget.onTapDownCallBack?.call(details);
