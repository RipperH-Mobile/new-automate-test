...
class InvalidTokenException implements ApiException {
  @override
  ...
  factory InvalidTokenException.fromMap(Map<String, dynamic> data) {
  ...
  @override
  String toString() {
    return 'InvalidTokenException: $code ($type): $name -> $message';
  }
