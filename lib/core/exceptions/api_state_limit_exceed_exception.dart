...
class ApiStateLimitExceedException implements ApiException {
  @override
  ...
  factory ApiStateLimitExceedException.fromMap(Map<dynamic, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ApiStateLimitExceedException(
  ...
  @override
  String toString() {
    return 'ApiStateLimitExceedException: $code ($type): $name -> $message';
  }
