...
class ErrorAccountNotFoundException implements ApiException {
  @override
  ...
  factory ErrorAccountNotFoundException.fromMap(Map<String, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ErrorAccountNotFoundException(
