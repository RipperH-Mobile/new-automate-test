...
class ErrorAccountEmailAlreadyExistException implements ApiException {
  @override
  ...
  ErrorAccountEmailAlreadyExistException({
  ...
  factory ErrorAccountEmailAlreadyExistException.fromMap(Map<String, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ErrorAccountEmailAlreadyExistException(
  ...
  @override
  String toString() {
    return 'ErrorAccountEmailAlreadyExist: $code ($type): $name -> $message';
  }
