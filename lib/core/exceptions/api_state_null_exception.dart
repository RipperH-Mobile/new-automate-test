...
class ApiStateNullException implements ApiException {
  @override
  ...
  factory ApiStateNullException.fromMap(Map<String, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ApiStateNullException(
