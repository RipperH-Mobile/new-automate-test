...
class ErrorAccountLimitPasswordValidationException implements ApiException {
  @override
  ...
  ErrorAccountLimitPasswordValidationException({
  ...
  factory ErrorAccountLimitPasswordValidationException.fromMap(Map<String, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ErrorAccountLimitPasswordValidationException(
  ...
  @override
  String toString() {
    return 'ErrorAccountLimitPasswordValidationException: $code ($type): $name -> $message';
  }
