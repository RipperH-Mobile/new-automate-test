...
class ErrorValidatePasswordCooldownException implements ApiException {
  @override
  ...
  ErrorValidatePasswordCooldownException({
  ...
  factory ErrorValidatePasswordCooldownException.fromMap(Map<String, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ErrorValidatePasswordCooldownException(
  ...
  @override
  String toString() {
    return 'ErrorValidatePasswordCooldownException: $code ($type): $name -> $message';
  }
