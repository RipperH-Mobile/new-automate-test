...
class ApiDeprecatedException implements ApiException {
  @override
  ...
  factory ApiDeprecatedException.fromMap(Map<dynamic, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ApiDeprecatedException(
  ...
  @override
  String toString() {
    return 'ApiDeprecatedException: $code ($type): $name -> $message';
  }
