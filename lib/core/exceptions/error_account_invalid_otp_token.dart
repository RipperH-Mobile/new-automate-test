...
class ErrorAccountInvalidOtpToken implements ApiException {
  @override
  ...
  factory ErrorAccountInvalidOtpToken.fromMap(Map<String, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ErrorAccountInvalidOtpToken(
  ...
  @override
  String toString() {
    return 'ErrorAccountOtpCooldown: $code ($type): $name -> $message';
  }
