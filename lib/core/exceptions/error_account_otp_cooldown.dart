...
class ErrorAccountOtpCooldown implements ApiException {
  @override
  ...
  factory ErrorAccountOtpCooldown.fromMap(Map<String, dynamic> data) {
    DataApiException? dataApiException;
    if (data['data'] != null) {
      dataApiException = DataApiException.fromMap(data['data']);
    }

    return ErrorAccountOtpCooldown(
