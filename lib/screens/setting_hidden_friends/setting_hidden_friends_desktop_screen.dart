...
class SettingHiddenFriendsDesktopScreen extends GetView<SettingHiddenFriendsController> {
  const SettingHiddenFriendsDesktopScreen({super.key});
    ...
    return ScaffoldBasic(
      ...
      child: CustomScrollView(
        slivers: [
          ...
          _contactList(context: context),
        ],
      ),
    );
  }

  Widget _contactList({required BuildContext context}) {
    return Obx(() {
      return SliverList(
                    ...
                    child: Row(
                      children: [
                        Padding(
                          ...
                          child: TextButton(
                            onPressed: () {
                              controller.onConfirmUnhide(contact);
                            },
                            style: ButtonStyle(
