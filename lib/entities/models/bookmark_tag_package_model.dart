...
class BookmarkTagPackageModel {
  ...
  // copyWith
  BookmarkTagPackageModel copyWith({
    String? coverId,
    ...
    return BookmarkTagPackageModel(
  ...
  factory BookmarkTagPackageModel.fromMap(Map<String, dynamic> json) => BookmarkTagPackageModel(
        id: json['_id'],
