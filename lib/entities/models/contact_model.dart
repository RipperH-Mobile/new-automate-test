...
class ContactModel with ContactMixin, UserMixin implements ContactInterface {
  ...
  factory ContactModel.fromEntity(ContactEntity entity) {
    return ContactModel(
      ...
      originalIsFriend: entity.originalIsFriend,
      blocked: entity.blocked,
      updatedAt: entity.updatedAt,
      createdAt: entity.createdAt,
      phoneNumber: entity.phoneNumber,
      googleAccount: entity.googleAccount,
      type: entity.type,
      ...
      vibraniumShield: entity.vibraniumShield,
      hiddenAt: entity.hiddenAt,
      blockedAt: entity.blockedAt,
    );
  }

  factory ContactModel.fromRoomMember(RoomMemberCollection member) {
    return ContactModel(
      id: member.accountId,
      displayName: member.account?.displayName,
      birthDate: member.account?.birthDate,
      username: member.account?.username,
      avatarId: member.account?.avatarId,
      originalIsFriend: member.account?.originalIsFriend,
      blocked: member.account?.blocked,
      updatedAt: member.account?.updatedAt,
      createdAt: member.account?.createdAt,
      phoneNumber: member.account?.phoneNumber,
      googleAccount: member.account?.googleAccount,
      type: member.account?.type,
      nickname: member.account?.nickname,
      backgroundId: member.account?.backgroundId,
      backgroundBlurhash: member.account?.backgroundBlurhash,
      hidden: member.account?.hidden,
      originalStatusMessage: member.account?.originalStatusMessage,
      lastSeenAt: member.account?.lastSeenAt,
      lastTypedAt: member.lastTypedAt,
      isTyping: member.account?.isTyping,
