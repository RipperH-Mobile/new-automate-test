...
part of 'room_menu_command_arg_model.dart';
...
const RoomMenuCommandArgModelSchema = Schema(
  name: r'RoomMenuCommandArgModel',
  id: 3139166469197061137,
  properties: {
  ...
  estimateSize: _roomMenuCommandArgModelEstimateSize,
  serialize: _roomMenuCommandArgModelSerialize,
  deserialize: _roomMenuCommandArgModelDeserialize,
  deserializeProp: _roomMenuCommandArgModelDeserializeProp,
);

int _roomMenuCommandArgModelEstimateSize(
  RoomMenuCommandArgModel object,
  List<int> offsets,
...
void _roomMenuCommandArgModelSerialize(
  RoomMenuCommandArgModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
RoomMenuCommandArgModel _roomMenuCommandArgModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = RoomMenuCommandArgModel(
...
P _roomMenuCommandArgModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension RoomMenuCommandArgModelQueryFilter on QueryBuilder<
    RoomMenuCommandArgModel, RoomMenuCommandArgModel, QFilterCondition> {
  QueryBuilder<RoomMenuCommandArgModel, RoomMenuCommandArgModel,
...
extension RoomMenuCommandArgModelQueryObject on QueryBuilder<
    RoomMenuCommandArgModel, RoomMenuCommandArgModel, QFilterCondition> {}
