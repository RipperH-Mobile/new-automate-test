...
import 'uchat_network_image_io.dart' as network_image;

/// [NetworkImage]
abstract class UChatNetworkImageProvider extends ImageProvider<UChatNetworkImageProvider>
    with ExtendedImageProvider<UChatNetworkImageProvider> {
  /// Creates an object that fetches the image at the given URL.
  ///
  /// The arguments [url] and [scale] must not be null.
  factory UChatNetworkImageProvider(
    String url, {
    double scale,
  ...
  }) = network_image.UChatNetworkImageProvider;
  ...
  static dynamic get httpClient => network_image.UChatNetworkImageProvider.httpClient;
}
