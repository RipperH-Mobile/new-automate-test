...
/// Formats a Unix timestamp (in milliseconds) for display in messages.
///
/// Rules:
/// - Less than 1 minute ago: "Now"
/// - Today: "HH:mm" (e.g., "15:30")
/// - Yesterday: "Yesterday"
/// - Older: "MMM d, yyyy" (e.g., "Mar 20, 2025")
String formatInAppNotificationTimestamp({
  int? timestamp,
  String locale = 'en',
}) {
  if (timestamp == null) {
  ...
  if (difference.inMinutes < 1) {
    ...
    return DateFormat('MMM d, yyyy', locale).format(messageTime);
  }
}
