...
class GiphyGif {
  ...
  factory GiphyGif.fromJson(Map<String, dynamic> json) => GiphyGif(
      ...
      trendingDatetime: json['trending_datetime'] == null ? null : DateTime.parse(json['trending_datetime'] as String),
      user: json['user'] == null ? null : GiphyUser.fromJson(json['user'] as Map<String, dynamic>),
      images: json['images'] == null ? null : GiphyImages.fromJson(json['images'] as Map<String, dynamic>));
  ...
  String get priorityUrl {
    final imageUrl = images?.previewWebp?.url ?? images?.previewGif?.url ?? images?.original?.url ?? '';
