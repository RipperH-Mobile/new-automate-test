...
class GiphyCollection {
  ...
  factory GiphyCollection.fromJson(Map<String, dynamic> json) {
    ...
    return GiphyCollection(
      data: data.map((e) => GiphyGif.fromJson(e as Map<String, dynamic>)).toList(),
      pagination:
          json['pagination'] == null ? null : GiphyPagination.fromJson(json['pagination'] as Map<String, dynamic>),
