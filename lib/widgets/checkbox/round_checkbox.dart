...
class UChatRoundCheckBox extends StatefulWidget {
  const UChatRoundCheckBox({
    super.key,
    this.isChecked,
    this.checkedWidget,
  ...
  @override
  UChatRoundCheckBoxState createState() => UChatRoundCheckBoxState();
}

class UChatRoundCheckBoxState extends State<UChatRoundCheckBox> {
  bool? isChecked;
  ...
  @override
  void didUpdateWidget(UChatRoundCheckBox oldWidget) {
