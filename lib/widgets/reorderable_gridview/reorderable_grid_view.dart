...
import 'package:uchat/widgets/reorderable_gridview/src/reorderable_item.dart' show ReorderableItemView;
import 'package:uchat/widgets/reorderable_gridview/src/reorderable_wrapper_widget.dart' show ReorderableWrapperWidget;
export 'package:uchat/widgets/reorderable_gridview/src/reorderable_sliver_grid_view.dart'
    show ReorderableSliverGridView;
...
class DragWidgetBuilderV2 {
  /// if true, will create a screenshot fo the drag widget
  final bool isScreenshotDragWidget;

  /// [screenshot] will not null if you provide isTakeScreenshotDragWidget = true.
