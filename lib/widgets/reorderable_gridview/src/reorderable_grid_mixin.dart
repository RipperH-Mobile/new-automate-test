...
import 'package:uchat/widgets/reorderable_gridview/reorderable_grid_view.dart';
...
mixin ReorderableGridStateMixin<T extends ReorderableGridWidgetMixin> on State<T>, TickerProviderStateMixin<T> {
  ...
  final Map<int, ReorderableItemViewState> __items = <int, ReorderableItemViewState>{};
