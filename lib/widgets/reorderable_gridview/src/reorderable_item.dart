...
import 'package:uchat/widgets/reorderable_gridview/src/reorderable_grid_mixin.dart';
...
class ReorderableItemViewState extends State<ReorderableItemView> with TickerProviderStateMixin {
  ...
  void _checkPlaceHolder() {
    ...
    if (selfPos != targetPos) {
      // any better idea?
      setState(() {
        debug('_buildPlaceHolder for index $index, _offset: $_placeholderOffset, _targetPos: $targetPos');
