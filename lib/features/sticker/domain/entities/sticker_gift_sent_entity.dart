...
class StickerGiftSentEntity {
  ...
  factory StickerGiftSentEntity.fromResponse(GetSentStickerGiftHistoryResponse response) {
    return StickerGiftSentEntity(
      ...
      giftToId: response.giftToId,
      giftTo: response.giftTo,
      expireAt: response.expireAt,
    );
  }

  StickerGiftSentEntity copyWith({
    String? packId,
    String? packName,
    String? packCoverId,
    String? description,
    ...
    return StickerGiftSentEntity(
      ...
      giftToId: giftToId ?? this.giftToId,
      giftTo: giftTo ?? this.giftTo,
    );
  }
}
