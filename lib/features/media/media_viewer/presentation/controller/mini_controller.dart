...
class _VideoAppLifeCycleObserver extends Object with WidgetsBindingObserver {
  ...
  final MiniController _controller;
...
class MiniController extends ValueNotifier<VideoPlayerValue> {
  ...
  MiniController.network(this.dataSource,
      {this.viewType = VideoViewType.textureView, this.httpHeaders = const <String, String>{}})
    ...
    void eventListener(VideoEvent event) {
      ...
      switch (event.eventType) {
        case VideoEventType.initialized:
          ...
          _platform.setLooping(_playerId, false);
          _applyPlayPause();
  ...
  Future<void> _applyVolume() async {
    ...
    await _platform.setVolume(_playerId, value.volume);
  }
