...
class ProfilePanel extends GetView<ProfileControllerV2> {
  const ProfilePanel({
    super.key,
  });
        ...
        children: [
          ...
          if (controller.showCallButton) ...[
            Obx(
              () => ProfileActionButton(
                ...
                onTap: !controller.isBlocked && controller.loading.isFalse
                    ? () {
          ...
          Obx(
            () => ProfileActionButton(
              ...
              onTap: !controller.isBlocked && controller.loading.isFalse ? controller.handleToggleMuteChat : null,
            ),
          ),
        ],
      ),
