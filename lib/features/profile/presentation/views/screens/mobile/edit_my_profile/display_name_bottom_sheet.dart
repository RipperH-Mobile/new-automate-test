...
class DisplayNameBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(SettingMyProfileDisplayNameController());
          ...
          Padding(
            ...
            child: Obx(
              () => AppTextField.withClear(
                ...
                onChanged: controller.onDisplayNameChange,
                autoFocus: true,
              ),
            ),
          ),
