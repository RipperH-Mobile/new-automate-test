...
class SearchAllMessageResultScreen extends GetView<SearchAllMessageResultController> {
  const SearchAllMessageResultScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return ScaffoldBasic(
      ...
      child: Obx(() {
        ...
        if (controller.messagePreviewList.isEmpty) {
  ...
  SliverToBoxAdapter _buildMessageHeader() {
    return SliverToBoxAdapter(
      child: Padding(
        padding: const EdgeInsets.only(bottom: AppSpace.space3, left: AppSpace.space4),
        child: Row(
          children: [
            AppText.body3Bold(
              'Messages'.tr,
    ...
    return Obx(
      () {
        return SliverPadding(
          padding: const EdgeInsets.only(bottom: AppSpace.space4, top: AppSpace.space4),
