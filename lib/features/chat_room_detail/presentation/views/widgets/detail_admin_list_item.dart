...
class DetailAdminListItem extends StatelessWidget {
  final RoomMemberEntity member;
  final VoidCallback? onTapProfile;
  final String? highLightName;

  const DetailAdminListItem({
    super.key,
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: AppText.body4(
                          member.groupRole?.role == RoomMemberRole.owner
                              ? 'Owner'
        ...
        Expanded(
          child: Row(
            children: [
              ...
              if (UserController.instance.isCurrentUser(member.account.id ?? ''))
                AppText.body3Bold(
                  '(You)'.tr,
                  context: context,
                ),
