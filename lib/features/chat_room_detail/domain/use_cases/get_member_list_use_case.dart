...
class GetMemberListUseCase extends SimpleUseCase<RoomCollection?, GetMemberListRequest> {
  ChatRoomDetailServerRepository get chatRoomDetailServerRepository {
    return GetIt.I<ChatRoomDetailServerRepository>();
  }

  @override
  Future<RoomCollection?> call(GetMemberListRequest params) {
    return chatRoomDetailServerRepository.getMyChatRoom(params);
  }
}
