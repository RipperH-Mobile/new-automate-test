...
class GetOneMemberUseCase extends SimpleUseCase<RoomMemberEntity?, GetOneMemberParams> {
  ChatRoomDetailLocalRepository get chatRoomDetailLocalRepository {
    return GetIt.I<ChatRoomDetailLocalRepository>();
  }

  @override
  Future<RoomMemberEntity?> call(GetOneMemberParams params) {
    return chatRoomDetailLocalRepository.getOneMemberInRoom(GetOneMemberInRoomRequest(
