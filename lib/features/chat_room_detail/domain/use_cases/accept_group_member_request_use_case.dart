...
class AcceptGroupMemberRequestUseCase extends SimpleUseCase<void, AcceptGroupMemberRequest> {
  ChatRoomDetailServerRepository get chatRoomDetailServerRepository {
    return GetIt.I<ChatRoomDetailServerRepository>();
  }

  @override
  Future<void> call(AcceptGroupMemberRequest params) {
    return chatRoomDetailServerRepository.acceptGroupMemberRequest(params);
  }
}
