...
class UpdateAdminsUseCase extends SimpleUseCase<void, UpdateAdminsRequest> {
  ChatRoomDetailServerRepository get chatRoomDetailServerRepository {
    return GetIt.I<ChatRoomDetailServerRepository>();
  }

  @override
  Future<void> call(UpdateAdminsRequest params) {
    return chatRoomDetailServerRepository.updateAdmins(params);
  }
}
