...
class ChangeGroupOwnerUseCase extends SimpleUseCase<void, ChangeGroupOwnerRequest> {
  ChatRoomDetailServerRepository get chatRoomDetailServerRepository {
    return GetIt.I<ChatRoomDetailServerRepository>();
  }

  @override
  Future<void> call(ChangeGroupOwnerRequest params) {
    return chatRoomDetailServerRepository.changeGroupOwner(params);
  }
}
