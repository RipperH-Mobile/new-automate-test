...
part of 'bookmark_tag_model.dart';
...
const BookmarkTagModelSchema = Schema(
  name: r'BookmarkTagModel',
  id: -860525147829930941,
  properties: {
  ...
  estimateSize: _bookmarkTagModelEstimateSize,
  serialize: _bookmarkTagModelSerialize,
  deserialize: _bookmarkTagModelDeserialize,
  deserializeProp: _bookmarkTagModelDeserializeProp,
);

int _bookmarkTagModelEstimateSize(
  BookmarkTagModel object,
  List<int> offsets,
...
void _bookmarkTagModelSerialize(
  BookmarkTagModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeString(offsets[2], object.defaultName);
  writer.writeString(offsets[3], object.emoji);
  writer.writeString(offsets[4], object.emojiTagId);
  writer.writeString(offsets[5], object.fileId);
  writer.writeLong(offsets[6], object.hashCode);
  writer.writeString(offsets[7], object.id);
  writer.writeBool(offsets[8], object.isDeletable);
  writer.writeString(offsets[9], object.name);
  writer.writeDateTime(offsets[10], object.updatedAt);
}

BookmarkTagModel _bookmarkTagModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = BookmarkTagModel(
    accountId: reader.readStringOrNull(offsets[0]),
    createdAt: reader.readDateTimeOrNull(offsets[1]),
    defaultName: reader.readStringOrNull(offsets[2]),
    emoji: reader.readStringOrNull(offsets[3]),
    emojiTagId: reader.readStringOrNull(offsets[4]),
...
P _bookmarkTagModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension BookmarkTagModelQueryFilter
    on QueryBuilder<BookmarkTagModel, BookmarkTagModel, QFilterCondition> {
  QueryBuilder<BookmarkTagModel, BookmarkTagModel, QAfterFilterCondition>
      accountIdIsNull() {
...
extension BookmarkTagModelQueryObject
    on QueryBuilder<BookmarkTagModel, BookmarkTagModel, QFilterCondition> {}
