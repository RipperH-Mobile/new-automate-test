...
part of 'deleted_by_account_model.dart';
...
const DeletedByAccountModelSchema = Schema(
  name: r'DeletedByAccountModel',
  id: 3835652130984924656,
  properties: {
  ...
  estimateSize: _deletedByAccountModelEstimateSize,
  serialize: _deletedByAccountModelSerialize,
  deserialize: _deletedByAccountModelDeserialize,
  deserializeProp: _deletedByAccountModelDeserializeProp,
);

int _deletedByAccountModelEstimateSize(
  DeletedByAccountModel object,
  List<int> offsets,
...
void _deletedByAccountModelSerialize(
  DeletedByAccountModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
DeletedByAccountModel _deletedByAccountModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = DeletedByAccountModel(
...
P _deletedByAccountModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension DeletedByAccountModelQueryFilter on QueryBuilder<
    DeletedByAccountModel, DeletedByAccountModel, QFilterCondition> {
  QueryBuilder<DeletedByAccountModel, DeletedByAccountModel,
...
extension DeletedByAccountModelQueryObject on QueryBuilder<
    DeletedByAccountModel, DeletedByAccountModel, QFilterCondition> {}
