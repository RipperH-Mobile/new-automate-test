...
class OpenDirectChatAndSaveToDbUseCase extends SimpleUseCase<RoomEntity?, OpenDirectChatRequest> {
  ...
  @override
  Future<RoomEntity?> call(OpenDirectChatRequest params) async {
    final res = await chatRoomServerRepository.openDirectChat(params);
