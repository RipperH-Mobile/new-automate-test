...
class EmojiPackageWithItemsEntity extends EmojiPackageEntity {
  List<EmojiItemModel>? emojiItems;

  EmojiPackageWithItemsEntity({
    super.coverId,
    super.coverImageUrl,
    super.createdAt,
    super.description,
  ...
  factory EmojiPackageWithItemsEntity.fromMap(Map<String, dynamic> json) => EmojiPackageWithItemsEntity(
        id: json['_id'],
        ...
        emojiItems: json['emojiItems'] == null
            ? []
            : List<EmojiItemModel>.from(json['emojiItems']!.map((x) => EmojiItemModel.fromMap(x))),
      );
