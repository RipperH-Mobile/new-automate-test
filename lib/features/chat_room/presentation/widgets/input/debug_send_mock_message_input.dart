...
class DebugSendMockMessageInput extends StatelessWidget {
  ...
  const DebugSendMockMessageInput({
    super.key,
        ...
        child: Form(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Assets.vectors.mockMessage.svg(width: 64, height: 64),
                ),
                const SizedBox(height: 24),
                Text(
                  'How many messages do you want to mock?'.tr,
