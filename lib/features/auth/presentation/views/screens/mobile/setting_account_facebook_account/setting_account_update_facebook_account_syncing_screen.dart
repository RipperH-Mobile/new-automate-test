...
class SettingAccountUpdateFacebookAccountSyncingScreen
    extends GetView<SettingAccountUpdateFacebookAccountSyncingController> {
  const SettingAccountUpdateFacebookAccountSyncingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      return controller.isSyncedWithFacebookAccount.value
          ? _buildUpdateScreen(context)
          : _buildUnregisterScreen(context);
    });
  }
        ...
        child: Column(
          children: [
              ...
              child: Obx(
                () => Column(
                  ...
                  children: [
                    ...
                    AppText.body1(
                      controller.facebookAccount.value,
                      maxLines: 1,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            AppText.body1(
                              'Unsync this Facebook account'.tr,
            ...
            SettingMeuBox.textWithArrow(
              context: context,
              text: 'Change to new Facebook account'.tr,
    ...
    return ScaffoldBasic(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Assets.images.facebookLinkV2.image(
              width: AppSize.size24,
              height: AppSize.size24,
            ),
            const SizedBox(height: AppSpace.space6),
            AppText.heading4(
              'Confirm to sync the account to a new Facebook account?'.tr,
              textAlign: TextAlign.center,
              context: context,
            ),
            const SizedBox(height: AppSpace.space2),
            AppText.body3(
              'Do you want to sync your account with Facebook account?'.tr,
              color: context.theme.appColors.textLight,
              textAlign: TextAlign.center,
              context: context,
            ),
