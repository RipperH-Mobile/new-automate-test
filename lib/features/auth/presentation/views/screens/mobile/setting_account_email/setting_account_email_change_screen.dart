...
class SettingAccountEmailChangeScreen extends GetView<SettingAccountEmailChangeController> {
  const SettingAccountEmailChangeScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ScaffoldBasic(
      appBar: AppBarDefault(
        title: controller.arguments.isChangeEmail ? 'Change email'.tr : 'Set Up Your Email'.tr,
